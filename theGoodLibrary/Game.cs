...
namespace The_Good_Place_Library
{
    public class Scoring
    {
        ...
        {
            var r = new Random();
            if (r.Next(5, 25) < Scoring.tortureLevel)
            {
                return true;
            }
            else
    ...
    public static class Dialog
    {
        ...
        {
            var readLines = File.ReadAllLines("mods.txt");
            var possibilties = new string[7];
            ...
            var allResults = new string[readLines.Length + possibilties.Length];
            Array.Copy(possibilties, allResults, possibilties.Length);
            Array.Copy(readLines, 0, allResults, possibilties.Length, allResults.Length);
            var r = new Random();
            return possibilties[r.Next(0, allResults.Length)];
        }
    }
