    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("He informs her that she is dead, killed after a line of shopping carts in the parking lot of a supermarket pushed her into the oncoming path of a truck which was advertising marital aid pills, " +
                              Environment.NewLine + "and the space they are in is a Heaven-like utopia called The Good Place.");
            Console.WriteLine("Also, every person in the Good Place has a soulmate, a person to spend their eternal life together.");
            Console.WriteLine("Your soulmate, Eleanor, is an ethics professor, his name is Chidi");
            Console.WriteLine("You are shown to your house, it is a modern, clown-themed, tailored to your preferences");
            Console.WriteLine("You utterly hate clowns, do you; 1) Complain to Micheal, or 2) Do nothing");
